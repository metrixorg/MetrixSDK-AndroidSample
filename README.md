...
<h3 id=session_event_description>توضیح مفاهیم رویداد (event) و نشست (session)</h3>
...
<h3 id=setEventUploadMaxBatchSize>۳. تعیین حداکثر تعداد رویداد ارسالی در هر درخواست</h3>
...
<h3 id=setEventMaxCount>۴. تعیین تعداد حداکثر ذخیره رویداد در مخزن کتابخانه</h3>
...
<h3 id=setEventUploadPeriodMillis>۵. تعیین بازه زمانی ارسال رویدادها به سمت سرور</h3>
...
<h3 id=setSessionTimeoutMillis>۶. تعیین بازه زمانی دلخواه برای نشست‌ها</h3>
...
<h3 id=setOptOut>۷. دستور عمل نکردن کل کتابخانه</h3>
...
<h3 id=setOffline>۱۰. روشن کردن حالت آفلاین کتابخانه</h3>
...
<h3 id=setFlushEventsOnClose>۱۱. فعال یا غیرفعال کردن ارسال همه‌ی رویدادها</h3>
...
<h3 id=getSessionNum>۱۲. اطلاع یافتن از شماره نشست جاری</h3>
...
- <b>ورودی اول:</b> نام رویداد مورد نظر شما که از جنس String است.<br>
